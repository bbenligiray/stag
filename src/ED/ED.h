...
EdgeMap* DetectEdgesByED(unsigned char* srcImg,
                         int width,
                         int height,
                         GradientOperator op = PREWITT_OPERATOR,
                         int GRADIENT_THRESH = 20,
                         int ANCHOR_THRESH = 0,
...
EdgeMap* DetectEdgesByEDV(unsigned char* srcImg,
                          int width,
                          int height,
                          GradientOperator op = PREWITT_OPERATOR,
                          int GRADIENT_THRESH = 20,
...
EdgeMap* DetectEdgesByCannySR(unsigned char* srcImg,
                              int width,
                              int height,
                              int cannyLowThresh,
                              int cannyHighThresh,
...
EdgeMap* CannyEDetectEdgesByCannyS2(unsigned char* srcImg,
                                    int width,
                                    int height,
                                    int cannyLowThresh,
                                    int cannyHighThresh,
...
EdgeMap* DetectEdgesByCannySRPF(unsigned char* srcImg,
                                int width,
                                int height,
                                int sobelKernelApertureSize = 3,
                                double smoothingSigma = 1.0);
...
EdgeMap* DetectEdgesByEDPF(unsigned char* ch1Img,
...
EdgeMap* DetectContourEdgeMapByED1(unsigned char* ch1Img,
                                   unsigned char* ch2Img,
                                   unsigned char* ch3Img,
                                   unsigned char* contourImg,
                                   int width,
...
EdgeMap* DetectContourEdgeMapByED3(unsigned char* ch1Img,
                                   unsigned char* ch2Img,
                                   unsigned char* ch3Img,
                                   unsigned char* contourImg,
                                   int width,
...
///------------------------------ Deneme stuff ---------------------------------------------------------------------------------------------
/// Detects edges by changing the size of the gradient operator depending on "smoothingSigma" parameter and sets GRADIENT_THRESH accordingly
EdgeMap* DetectEdgesByED10(unsigned char* srcImg,
                           int width,
                           int height,
                           int GRADIENT_THRESH,
                           int ANCHOR_THRESH,
...
EdgeMap* DetectEdgesByED10(unsigned char* ch1Img,
                           unsigned char* ch2Img,
                           unsigned char* ch3Img,
                           int width,
                           int height,
                           ...
                           int ANCHOR_THRESH,
                           double smoothingSigma);
EdgeMap* DetectEdgesByED10V(unsigned char* ch1Img,
                            unsigned char* ch2Img,
                            unsigned char* ch3Img,
                            int width,
                            int height,
...
EdgeMap* DetectEdgesByED11(unsigned char* ch1Img,
                           unsigned char* ch2Img,
                           unsigned char* ch3Img,
                           int width,
                           int height,
